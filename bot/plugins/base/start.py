...
# اضافه کردن این دیکشنری برای ذخیره زمان آخرین ارسال هر کاربر (از version 1)
...
async def file_start(
    ...
    # --- کد جدید: چک تاخیر برای کاربران رایگان (اضافه شده از version 1) ---
